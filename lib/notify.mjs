// Pure logic for the consolidated website-contact route (api/notify.js).
//
...
// or a live Anthropic key: api/notify.js does the I/O, this file decides
...
export const NOTIFY_TO_ADDRESS = 'blue@mobluehq.com';
export const NOTIFY_FROM_ADDRESS = 'blue@mobluehq.com';
export const NOTIFY_FROM_NAME = 'MOBLUEHQ Website';
...
export function buildMailPayload(submission, triage) {
  ...
  const payload = {
    personalizations: [{ to: [{ email: NOTIFY_TO_ADDRESS }] }],
    from: { email: NOTIFY_FROM_ADDRESS, name: NOTIFY_FROM_NAME },
